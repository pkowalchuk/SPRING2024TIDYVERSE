...
### Reordering levels (plus a graph)
...
This vignette is part of a collaboration project to build out a book of examples on how to use TidyVerse functions in the our class [TidyVerse GitHub repository](https://github.com/pkowalchuk/SPRING2024TIDYVERSE). View the README.md file to see the commit to this code, a description of the commit, and a link to the markdown containing this example.
