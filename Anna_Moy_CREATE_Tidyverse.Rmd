...
There are many more functions in dplyr and ggplot2, and below, we introduce a few more to (1) identify the category with the highest mean calories per gram and (2) create a graph of the calories per gram for each item in that category.
